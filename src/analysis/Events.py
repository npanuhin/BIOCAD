...
# --------------------------------------------------------------------------------> Deletion
class Deletion:
    def __init__(self, start_x, length):
        self.type = "Deletion"
        self.start_x = start_x
        self.length = length

    def __repr__(self):
        return "Deletion(start_x={}, length={})".format(
...
# --------------------------------------------------------------------------------> Insertion
class Insertion:
    def __init__(self, start_y, height):
        self.type = "Insertion"
        self.start_y = start_y
        self.height = height

    def __repr__(self):
        return "Insertion(start_y={}, height={})".format(
...
# --------------------------------------------------------------------------------> Translocation
class Translocation:
    def __init__(self, start_line, end_line, order):
    ...
    def __repr__(self):
        return "Translocation(start_line={}, end_line={}, order=[{}])".format(
            self.start_line, self.end_line, ", ".join(map(str, self.order))
        )
