...
> Presentation documents (RU) are located in the [docs folder](docs)


[View current test results](https://github.com/npanuhin/BIOCAD/blob/master/output/analysis/README.md)

## Probably useful
* [Web-site](https://www.ncbi.nlm.nih.gov) with cut off genomes
* [BLAST partly algo explanation](https://en.wikipedia.org/wiki/BLAST_(biotechnology))
* [DUST algo](https://kodomo.fbb.msu.ru/FBB/year_10/ppt/DUST.pdf)
* [E-value pt.1](https://www.youtube.com/watch?v=jA_ROVJTQF8&t=275s)
& [E-value pt.2](https://www.youtube.com/watch?v=i-IDrTrPMFg)
